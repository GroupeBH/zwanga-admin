    ...
    <div className={styles.page}>
      <div className={styles.container}>
        <header className={styles.header}>
          <h1>{language === 'fr' ? 'Politique de Confidentialité – Zwanga' : 'Privacy Policy – Zwanga'}</h1>
          <p className={styles.lastUpdated}>
            {language === 'fr' 
              ? 'Date d’entrée en vigueur : 9 mars 2026<br />Dernière mise à jour : 9 mars 2026'
              : 'Effective date: March 9, 2026<br />Last updated: March 9, 2026'
            }
          </p>
